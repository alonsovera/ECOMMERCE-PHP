...
<section class="row-section contacto">
    <div class="content">
        <div class="grid-content grid-two gap-0">
            <div class="">
                <img src="../Content/image/icons/contacto.png" class="phone-contacto" alt="">
            </div>
            <div>
                <h1>¿Tienes alguna duda? <br> Contácte con <b>Master In Pets</b></h1>
                <a target="_blank" href="https://api.whatsapp.com/send?phone=+51924121113&text=Hola%20Master%20In%20Pets%20quisiera%20m%C3%A1s%20informaci%C3%B3n%20sobre%20los%20servicios%20que%20vi%20en%20la%20web" class="btn-aqui">Aquí</a>
                <div class="otros-medios">
                    <p>o buscanos por estos medios:</p>
                    <ul>
                        <li><i class="fa fa-phone"></i>+51 924 121 113</li>
                        <li><a href="mailto:Citypetsveterinaria@gmail.com"><i class="fa fa-envelope"></i> Citypetsveterinaria@gmail.com</a></li>
                        <li><i class="fa fa-map-marker"></i> Avenida Haya De La Torre, Int. 982-984 La Perla Distrito:Callao, Callao 07016</li>
                    </ul>
                </div>
