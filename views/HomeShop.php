    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function cargarProductos(filtro = '') {
                $.ajax({
                    url: '../controllers/Producto/MostrarProducto.php',
                    type: 'GET',
                    data: { filtro: filtro },
                    ...
                    error: function() {
                        $('#product-container').html('<p>Error al cargar los productos.</p>');
                    }
                });
            }
            ...
            function agregarAlCarrito(pkProducto) {
                var pkCarrito = userCarrito; 
                console.log("Producto agregado al carrito: " + pkProducto+ ','+userCarrito );

                
                $.ajax({
                    url: '../controllers/Carrito/AgregarDetalleCarrito.php', 
                    type: 'POST',
                    asyn: false,
                    data: {
